...
I've led this work across four brands and thirteen properties over eight years. At Metro International I scoped and shipped a CMS from scratch in three months and migrated metro.us onto it. At Newsweek, a full CMS and front-end replatform on a property doing 50 million monthly uniques. GQ's front-end replatform ran across ten markets, on an upgraded CMS. Condé Nast Traveller's Spain and LATAM sites were consolidated onto one Spanish-language platform built to serve 56.6 million uniques.
